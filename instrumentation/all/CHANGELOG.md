...
* [#1378](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1378) - chore: bump simplecov to 0.22.0
  will replace #1367
...
* [#1394](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1394) - release: Release 5 gems
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-all 0.73.0** (was 0.72.0)
   *  **opentelemetry-instrumentation-redis 0.26.1** (was 0.26.0)
   *  **opentelemetry-instrumentation-rails 0.36.0** (was 0.35.1)
   *  **opentelemetry-instrumentation-aws_lambda 0.3.0** (was 0.2.0)
   *  **opentelemetry-instrumentation-action_pack 0.12.0** (was 0.11.0)
...
* [#1396](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1396) - fix: add require active_storage instrumentation to `all`
  related: #1307 
  ...
  ![image](https://github.com/user-attachments/assets/56422789-c223-481c-b18a-4c88c0c7d503)

* [#1397](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1397) - release: Release opentelemetry-instrumentation-all 0.73.1 (was 0.73.0)
  *  **opentelemetry-instrumentation-all 0.73.1** (was 0.73.0)

* [#1407](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1407) - release: Release 2 gems
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-rdkafka 0.6.0** (was 0.5.0)
   *  **opentelemetry-instrumentation-all 0.74.0** (was 0.73.1)
...
* [#1471](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1471) - feat: Add `opentelemetry-instrumentation-grpc` to `-all`
  The final step to migrate the gRPC gem into the OpenTelemetry ecosystem.
  
  0.2.0 was released by OpenTelemetry on 2 April, 2025.

* [#1485](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1485) - release: Release 2 gems
  *  **opentelemetry-instrumentation-dalli 0.27.0** (was 0.26.0)
   *  **opentelemetry-instrumentation-all 0.75.0** (was 0.74.0)

* [#1488](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1488) - release: Release 4 gems
  *  **opentelemetry-instrumentation-trilogy 0.61.1** (was 0.61.0)
   *  **opentelemetry-instrumentation-mysql2 0.29.1** (was 0.29.0)
   *  **opentelemetry-instrumentation-pg 0.30.1** (was 0.30.0)
   *  **opentelemetry-instrumentation-all 0.75.1** (was 0.75.0)

* [#1524](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1524) - release: Release 2 gems
  *  **opentelemetry-propagator-xray 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-rdkafka 0.7.0** (was 0.6.0)

* [#1526](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1526) - release: Release opentelemetry-instrumentation-all 0.76.0 (was 0.75.1)
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-all 0.76.0** (was 0.75.1)
...
* [#1554](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1554) - release: Release 4 gems
  *  **opentelemetry-instrumentation-rake 0.3.1** (was 0.3.0)
   *  **opentelemetry-instrumentation-faraday 0.27.0** (was 0.26.0)
   *  **opentelemetry-resource-detector-aws 0.4.0** (was 0.3.0)
   *  **opentelemetry-instrumentation-all 0.77.0** (was 0.76.0)
...
* [#1566](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1566) - release: Release 2 gems
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-http 0.25.0** (was 0.24.0)
   *  **opentelemetry-instrumentation-all 0.78.0** (was 0.77.0)
...
* [#1610](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1610) - release: Release 5 gems
  *  **opentelemetry-instrumentation-aws_sdk 0.8.2** (was 0.8.1)
   *  **opentelemetry-instrumentation-http_client 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-ethon 0.23.0** (was 0.22.0)
   *  **opentelemetry-instrumentation-net_http 0.23.1** (was 0.23.0)
   *  **opentelemetry-instrumentation-restclient 0.24.0** (was 0.23.0)
...
* [#1627](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1627) - release: Release 3 gems
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-httpx 0.3.0** (was 0.2.1)
   *  **opentelemetry-instrumentation-excon 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-faraday 0.28.0** (was 0.27.0)
...
* [#1628](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1628) - feat: Add HTTPX instrumentation to all
  Now, HTTPX instrumentation will be automatically applied if the HTTPX gem is installed in a user's environment.

* [#1638](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1638) - release: Release opentelemetry-instrumentation-all 0.79.0 (was 0.78.0)
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-all 0.79.0** (was 0.78.0)
...
* [#1644](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1644) - release: Release 5 gems
  This pull request prepares new gem releases for the following gems:
  
   *  **opentelemetry-instrumentation-all 0.80.0** (was 0.79.0)
   *  **opentelemetry-instrumentation-rails 0.37.0** (was 0.36.0)
   *  **opentelemetry-instrumentation-action_pack 0.13.0** (was 0.12.3)
   *  **opentelemetry-instrumentation-sinatra 0.26.0** (was 0.25.0)
   *  **opentelemetry-instrumentation-rack 0.27.0** (was 0.26.0)
...
* Co-authored-by: release: Release 5 gems ([#1644](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1644) [369c200](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/369c20097572c3ea517871bb30d501d61c1a6ec2))
  This pull request prepares new gem releases for the following gems:
...
* release: release: Release 5 gems ([#1644](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1644) [369c200](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/369c20097572c3ea517871bb30d501d61c1a6ec2))
  This pull request prepares new gem releases for the following gems:
...
* Co-authored-by: release: Release 5 gems ([#1394](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1394) [02823b3](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/02823b3b969c9dc1ed5ee4e5ebdb9ce86590810f))
  This pull request prepares new gem releases for the following gems:
...
* release: release: Release 5 gems ([#1394](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1394) [02823b3](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/02823b3b969c9dc1ed5ee4e5ebdb9ce86590810f))
  This pull request prepares new gem releases for the following gems:
...
* Co-authored-by: release: Release opentelemetry-instrumentation-all 0.79.0 (was 0.78.0) ([#1638](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1638) [74ff80a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/74ff80a2573a8c7dde557aa9b09e767501a5da50))
  This pull request prepares new gem releases for the following gems:
...
* release: release: Release opentelemetry-instrumentation-all 0.79.0 (was 0.78.0) ([#1638](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1638) [74ff80a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/74ff80a2573a8c7dde557aa9b09e767501a5da50))
  This pull request prepares new gem releases for the following gems:
...
* **NEW:** feat: Add HTTPX instrumentation to all ([#1628](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1628) [15ebe4d](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/15ebe4dddc7620f5b28ada67e9d92bfab02b9fbe))
  Now, HTTPX instrumentation will be automatically applied if the HTTPX gem is installed in a user's environment.

* Co-authored-by: release: Release 3 gems ([#1627](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1627) [e74539e](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/e74539e855722139fc92d0b3c631c75096d2faeb))
  This pull request prepares new gem releases for the following gems:
...
* release: release: Release 3 gems ([#1627](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1627) [e74539e](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/e74539e855722139fc92d0b3c631c75096d2faeb))
  This pull request prepares new gem releases for the following gems:
...
* Co-authored-by: release: Release 5 gems ([#1610](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1610) [2ceaf46](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/2ceaf46cf0844397aa77e68cee5467c8810ad67b))
  *  **opentelemetry-instrumentation-aws_sdk 0.8.2** (was 0.8.1)
   *  **opentelemetry-instrumentation-http_client 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-ethon 0.23.0** (was 0.22.0)
   *  **opentelemetry-instrumentation-net_http 0.23.1** (was 0.23.0)
...
* release: release: Release 5 gems ([#1610](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1610) [2ceaf46](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/2ceaf46cf0844397aa77e68cee5467c8810ad67b))
  *  **opentelemetry-instrumentation-aws_sdk 0.8.2** (was 0.8.1)
   *  **opentelemetry-instrumentation-http_client 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-ethon 0.23.0** (was 0.22.0)
   *  **opentelemetry-instrumentation-net_http 0.23.1** (was 0.23.0)
...
* Co-authored-by: release: Release 2 gems ([#1566](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1566) [62e4b1c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/62e4b1c13f09f64701aa9937d17c6c8b5bf0c9ce))
  This pull request prepares new gem releases for the following gems:
...
* release: release: Release 2 gems ([#1566](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1566) [62e4b1c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/62e4b1c13f09f64701aa9937d17c6c8b5bf0c9ce))
  This pull request prepares new gem releases for the following gems:
...
* Co-authored-by: release: Release 4 gems ([#1554](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1554) [ca00ab0](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/ca00ab0fb11cc1b6aa24db6072f6a8c09cd4ed74))
  *  **opentelemetry-instrumentation-rake 0.3.1** (was 0.3.0)
   *  **opentelemetry-instrumentation-faraday 0.27.0** (was 0.26.0)
   *  **opentelemetry-resource-detector-aws 0.4.0** (was 0.3.0)
   *  **opentelemetry-instrumentation-all 0.77.0** (was 0.76.0)
...
* release: release: Release 4 gems ([#1554](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1554) [ca00ab0](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/ca00ab0fb11cc1b6aa24db6072f6a8c09cd4ed74))
  *  **opentelemetry-instrumentation-rake 0.3.1** (was 0.3.0)
   *  **opentelemetry-instrumentation-faraday 0.27.0** (was 0.26.0)
   *  **opentelemetry-resource-detector-aws 0.4.0** (was 0.3.0)
   *  **opentelemetry-instrumentation-all 0.77.0** (was 0.76.0)

* Co-authored-by: release: Release opentelemetry-instrumentation-all 0.76.0 (was 0.75.1) ([#1526](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1526) [b4d1ec4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/b4d1ec4a5bd54c2e6e4d9fd595f0a3370dedcfac))
  This pull request prepares new gem releases for the following gems:
...
* release: release: Release opentelemetry-instrumentation-all 0.76.0 (was 0.75.1) ([#1526](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1526) [b4d1ec4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/b4d1ec4a5bd54c2e6e4d9fd595f0a3370dedcfac))
  This pull request prepares new gem releases for the following gems:
...
* Co-authored-by: release: Release 2 gems ([#1524](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1524) [e006eb6](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/e006eb689860d578a9b248c2085d0d1f9528706a))
  *  **opentelemetry-propagator-xray 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-rdkafka 0.7.0** (was 0.6.0)
...
* release: release: Release 2 gems ([#1524](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1524) [e006eb6](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/e006eb689860d578a9b248c2085d0d1f9528706a))
  *  **opentelemetry-propagator-xray 0.24.0** (was 0.23.0)
   *  **opentelemetry-instrumentation-rdkafka 0.7.0** (was 0.6.0)

* Co-authored-by: release: Release 4 gems ([#1488](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1488) [0558844](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/055884401e08e3a99be714953c271c5eecf15a27))
  *  **opentelemetry-instrumentation-trilogy 0.61.1** (was 0.61.0)
   *  **opentelemetry-instrumentation-mysql2 0.29.1** (was 0.29.0)
   *  **opentelemetry-instrumentation-pg 0.30.1** (was 0.30.0)
   *  **opentelemetry-instrumentation-all 0.75.1** (was 0.75.0)
...
* release: release: Release 4 gems ([#1488](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1488) [0558844](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/055884401e08e3a99be714953c271c5eecf15a27))
  *  **opentelemetry-instrumentation-trilogy 0.61.1** (was 0.61.0)
   *  **opentelemetry-instrumentation-mysql2 0.29.1** (was 0.29.0)
   *  **opentelemetry-instrumentation-pg 0.30.1** (was 0.30.0)
   *  **opentelemetry-instrumentation-all 0.75.1** (was 0.75.0)

* Co-authored-by: release: Release 2 gems ([#1485](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1485) [24a4a7c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/24a4a7ca68402eed3da0c7ddc05d1f5b1aeacdbe))
  *  **opentelemetry-instrumentation-dalli 0.27.0** (was 0.26.0)
   *  **opentelemetry-instrumentation-all 0.75.0** (was 0.74.0)
...
* release: release: Release 2 gems ([#1485](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1485) [24a4a7c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/24a4a7ca68402eed3da0c7ddc05d1f5b1aeacdbe))
  *  **opentelemetry-instrumentation-dalli 0.27.0** (was 0.26.0)
   *  **opentelemetry-instrumentation-all 0.75.0** (was 0.74.0)

* **NEW:** feat: Add `opentelemetry-instrumentation-grpc` to `-all` ([#1471](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1471) [c5395f9](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/c5395f93b36d4c823998adcf0e8a39277df74260))
  The final step to migrate the gRPC gem into the OpenTelemetry ecosystem.
  
  0.2.0 was released by OpenTelemetry on 2 April, 2025.

* release: release: Release 2 gems ([#1407](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1407) [7d2aff7](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/7d2aff7670b9d687bf21b573c503f4173a0e5080))
  This pull request prepares new gem releases for the following gems:
...
* Co-authored-by: release: Release opentelemetry-instrumentation-all 0.73.1 (was 0.73.0) ([#1397](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1397) [5a1c929](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/5a1c929e4c4e8e21d46388ddf48a2c091fe74f7b))
  *  **opentelemetry-instrumentation-all 0.73.1** (was 0.73.0)

* Co-authored-by: release: Release opentelemetry-instrumentation-all 0.73.1 (was 0.73.0) ([#1397](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1397) [5a1c929](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/5a1c929e4c4e8e21d46388ddf48a2c091fe74f7b))
  *  **opentelemetry-instrumentation-all 0.73.1** (was 0.73.0)

* release: release: Release opentelemetry-instrumentation-all 0.73.1 (was 0.73.0) ([#1397](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1397) [5a1c929](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/5a1c929e4c4e8e21d46388ddf48a2c091fe74f7b))
  *  **opentelemetry-instrumentation-all 0.73.1** (was 0.73.0)

* **FIX:** fix: add require active_storage instrumentation to `all` ([#1396](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1396) [711be26](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/711be26cee57769fe15f5e56c5e8724d64403fd1))
  related: #1307 
...
* chore: bump simplecov to 0.22.0 ([#1378](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1378) [d0444df](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/d0444dfd6b12b53df3593bc56c982d10bfcc5f4e))
  will replace #1367

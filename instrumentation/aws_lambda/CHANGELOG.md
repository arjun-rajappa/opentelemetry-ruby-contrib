...
* [#1308](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1308) - feat: AWS lambda programatic wrap
...
* [#1383](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1383) - fix: aws_lambda test fix
  Change `tracestate.to_h.to_s` to `.to_json` to avoid the space cause error.
...
* **FIX:** fix: aws_lambda test fix ([#1383](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1383) [4db8fc9](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/4db8fc9bbd9bd267ef7fba3490b956604e0aa543))
  Change `tracestate.to_h.to_s` to `.to_json` to avoid the space cause error.

* feat: AWS lambda programatic wrap ([#1308](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1308) [fb9cdf4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/fb9cdf42d6f14736b630a974d0fab878a4f66145))
  Our company uses container images for deploying our lambda functions and use herokuish Procfile entries as our entrypoints for the images.
...
* **NEW:** feat: AWS lambda programatic wrap ([#1308](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1308) [fb9cdf4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/fb9cdf42d6f14736b630a974d0fab878a4f66145))
  Our company uses container images for deploying our lambda functions and use herokuish Procfile entries as our entrypoints for the images.

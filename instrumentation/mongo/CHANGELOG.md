...
* [#1537](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1537) - test: Add less restrictive gem spec for mongo gem
...
* [#1567](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1567) - test: Install older version of bson for JRuby
...
* **TEST:** test: Install older version of bson for JRuby ([#1567](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1567) [0d74059](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/0d74059b09e40c219d284033d5af819e6826ec4a))
  At this time, bson 5.1.0 is not compatible with JRuby 9.x. (It might be compatible with JRuby 10, but we're not running that in our tests yet) 
  
  This updates the appraisal to run an older version if we're on JRuby.

* **TEST:** test: Add less restrictive gem spec for mongo gem ([#1537](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1537) [47de526](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/47de526ce3789e56f19c21f8d55588ff017c5cf0))
  It looks like latest features (including jruby 10 enablement) will require the latest minor release of the mongo gem.

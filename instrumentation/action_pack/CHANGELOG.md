...
* [#1375](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1375) - feat: Strip Rails `(.:format)` suffix from `http.route`
...
* [#1387](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1387) - test: Relax Webmock Constraints
  This would have made upgrading to [Ruby 3.4](https://github.com/open-telemetry/opentelemetry-ruby/pull/1803) simpler.
...
* [#1527](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1527) - fix: Account for `nil` routes
...
* [#1529](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1529) - release: Release 2 gems
  *  **opentelemetry-instrumentation-action_pack 0.12.1** (was 0.12.0)
   *  **opentelemetry-resource-detector-aws 0.3.0** (was 0.2.0)

* [#1539](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1539) - chore: bump DavidAnson/markdownlint-cli2-action from 19 to 20
  ...
  <p>No release notes provided.</p>
  <h2>Update markdownlint version (markdownlint-cli2 v0.6.0, markdownlint v0.27.0).</h2>
  <p>No release notes provided.</p>
  <h2>Update markdownlint version (markdownlint-cli2 v0.5.1, markdownlint v0.26.2).</h2>
  <p>No release notes provided.</p>
  <h2>Update markdownlint version (markdownlint-cli2 v0.4.0, markdownlint v0.25.1)</h2>
  <p>No release notes provided.</p>
  </blockquote>
  </details>
  <details>
  <summary>Commits</summary>
  <ul>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/992badcdf24e3b8eb7e87ff9287fe931bcb00c6e"><code>992badc</code></a> Update to version 20.0.0.</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/fafa44c8d420895b81af631b4477489a9e2e04f5"><code>fafa44c</code></a> Update dependency: markdownlint-cli2 to 0.18.1.</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/052b33619488b44c40f00f31e17d7a4f4cf4fd0e"><code>052b336</code></a> Bump eslint-plugin-n from 17.17.0 to 17.18.0</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/e0b0869c706556249cc82799c9fcfd4259f646f8"><code>e0b0869</code></a> Bump eslint-plugin-unicorn from 59.0.0 to 59.0.1</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/96cc31310ccfb4e75a935bffafb6a960b1561249"><code>96cc313</code></a> Bump <code>@​eslint/js</code> from 9.25.1 to 9.26.0</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/66095aa6874af3f7768280cd38b5e97f236e4a6d"><code>66095aa</code></a> Bump eslint from 9.25.1 to 9.26.0</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/51af1d1b7bc13402e1345b391463408cd066b780"><code>51af1d1</code></a> Bump eslint-plugin-unicorn from 58.0.0 to 59.0.0</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/81f63045705e8911dd6644c6f008854043d73664"><code>81f6304</code></a> Bump <code>@​eslint/js</code> from 9.25.0 to 9.25.1</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/e2c95fbdf26d1a8a9b343eb88a4b4d8e762a53b9"><code>e2c95fb</code></a> Bump eslint from 9.25.0 to 9.25.1</li>
  <li><a href="https://github.com/DavidAnson/markdownlint-cli2-action/commit/9f58cc3808058007cebc54088fa42da5075ec634"><code>9f58cc3</code></a> Bump <code>@​eslint/js</code> from 9.24.0 to 9.25.0</li>
  <li>Additional commits viewable in <a href="https://github.com/davidanson/markdownlint-cli2-action/compare/v19...v20">compare view</a></li>
  </ul>
  </details>
  <br />

* [#1555](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1555) - fix: rack span class naming
  ### What
...
* [#1557](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1557) - release: Release opentelemetry-instrumentation-action_pack 0.12.2 (was 0.12.1)
  *  **opentelemetry-instrumentation-action_pack 0.12.2** (was 0.12.1)
...
* [#1562](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1562) - fix: action_pack always assuming sdk spans
...
* [#1564](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1564) - release: Release opentelemetry-instrumentation-action_pack 0.12.3 (was 0.12.2)
  *  **opentelemetry-instrumentation-action_pack 0.12.3** (was 0.12.2)

* [#1594](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1594) - feat: Rack semantic stability opt in
...
* feat: Rack semantic stability opt in ([#1594](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1594) [49a2982](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/49a29827704c3efa4669a7fe21098652fba58629))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* **NEW:** feat: Rack semantic stability opt in ([#1594](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1594) [49a2982](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/49a29827704c3efa4669a7fe21098652fba58629))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* Co-authored-by: release: Release opentelemetry-instrumentation-action_pack 0.12.3 (was 0.12.2) ([#1564](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1564) [a83b342](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a83b342bbc80a756fce5fdef4c5d0fd355b77386))
  *  **opentelemetry-instrumentation-action_pack 0.12.3** (was 0.12.2)

* Co-authored-by: release: Release opentelemetry-instrumentation-action_pack 0.12.3 (was 0.12.2) ([#1564](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1564) [a83b342](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a83b342bbc80a756fce5fdef4c5d0fd355b77386))
  *  **opentelemetry-instrumentation-action_pack 0.12.3** (was 0.12.2)

* release: release: Release opentelemetry-instrumentation-action_pack 0.12.3 (was 0.12.2) ([#1564](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1564) [a83b342](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a83b342bbc80a756fce5fdef4c5d0fd355b77386))
  *  **opentelemetry-instrumentation-action_pack 0.12.3** (was 0.12.2)

* **FIX:** fix: action_pack always assuming sdk spans ([#1562](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1562) [6703511](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/670351189a62dfe29e4fd5003947796388e1579e))
  `span.name` is not a method on api/non recording spans. This small refactor changes the logic around renaming to stop relying on the presence of `span.name` for when the naming convention is `class_name`. 
...
* Co-authored-by: release: Release opentelemetry-instrumentation-action_pack 0.12.2 (was 0.12.1) ([#1557](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1557) [08e3ff4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/08e3ff4a3ffdd23569c432e280c9600751d56578))
  *  **opentelemetry-instrumentation-action_pack 0.12.2** (was 0.12.1)

* Co-authored-by: release: Release opentelemetry-instrumentation-action_pack 0.12.2 (was 0.12.1) ([#1557](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1557) [08e3ff4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/08e3ff4a3ffdd23569c432e280c9600751d56578))
  *  **opentelemetry-instrumentation-action_pack 0.12.2** (was 0.12.1)

* release: release: Release opentelemetry-instrumentation-action_pack 0.12.2 (was 0.12.1) ([#1557](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1557) [08e3ff4](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/08e3ff4a3ffdd23569c432e280c9600751d56578))
  *  **opentelemetry-instrumentation-action_pack 0.12.2** (was 0.12.1)

* **FIX:** fix: rack span class naming ([#1555](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1555) [41702d6](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/41702d668f588332b6ca45ee22e682680ebc0b35))
  ### What
...
* Co-authored-by: release: Release 2 gems ([#1529](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1529) [0e11770](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/0e117703b09372a641f7dcfb812e1a9852ebbe24))
  *  **opentelemetry-instrumentation-action_pack 0.12.1** (was 0.12.0)
   *  **opentelemetry-resource-detector-aws 0.3.0** (was 0.2.0)
...
* release: release: Release 2 gems ([#1529](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1529) [0e11770](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/0e117703b09372a641f7dcfb812e1a9852ebbe24))
  *  **opentelemetry-instrumentation-action_pack 0.12.1** (was 0.12.0)
   *  **opentelemetry-resource-detector-aws 0.3.0** (was 0.2.0)

* **FIX:** fix: Account for `nil` routes ([#1527](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1527) [75ba22b](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/75ba22bd61d4d59c822f591f16cf72463b975fc7))
  It seems that there are cases in Rails functional tests where it bypasses the routing system and the `action_dispatch.route_uri_pattern` header not being set.
...
* feat: Strip Rails `(.:format)` suffix from `http.route` ([#1375](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1375) [1e9853a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/1e9853aa5ff5358aca0c572dafa5db40c2168442))
  In our OpenTelemetry spans, all `http.route` values end in `(.:format)`. This is unsightly and does not help when diagnosing an issue using traces. It also stands out as different from the `http.route` produced by other language's OTel SDKs, which only include parts of the URL path itself.
  
  With this change, we strip this suffix from `http.route`, just like we are already doing for the span name.

* **NEW:** feat: Strip Rails `(.:format)` suffix from `http.route` ([#1375](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1375) [1e9853a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/1e9853aa5ff5358aca0c572dafa5db40c2168442))
  In our OpenTelemetry spans, all `http.route` values end in `(.:format)`. This is unsightly and does not help when diagnosing an issue using traces. It also stands out as different from the `http.route` produced by other language's OTel SDKs, which only include parts of the URL path itself.
...
* chore: bump DavidAnson/markdownlint-cli2-action from 19 to 20 ([#1539](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1539) [645d1ca](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/645d1ca5392fa7c38b757293713b96c9fdb80b5c))
  Bumps [DavidAnson/markdownlint-cli2-action](https://github.com/davidanson/markdownlint-cli2-action) from 19 to 20.
  <details>
  <summary>Release notes</summary>
  <p><em>Sourced from <a href="https://github.com/davidanson/markdownlint-cli2-action/releases">DavidAnson/markdownlint-cli2-action's releases</a>.</em></p>
...
* **TEST:** test: Relax Webmock Constraints ([#1387](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1387) [32e8fcb](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/32e8fcbfb76e8c62473ca3c2e1d3ad471258a118))
  This would have made upgrading to [Ruby 3.4](https://github.com/open-telemetry/opentelemetry-ruby/pull/1803) simpler.

...
* [#1456](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1456) - fix: httpx instrumentation trace context propagation
  This PR should supersede https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1404 . It fixes distributed tracing propagation (the aim of the original MR). It also drops support for httpx < 1.x; it may still work with it, but the `webmock` integration with it is no longer made possible.
...
* [#1508](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1508) - release: Release 2 gems
...
* [#1589](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1589) - feat: HTTPX semantic convention stability opt in
...
* feat: HTTPX semantic convention stability opt in ([#1589](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1589) [07de1d6](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/07de1d62ec915f584e60653242acba1f9f33702a))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* **NEW:** feat: HTTPX semantic convention stability opt in ([#1589](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1589) [07de1d6](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/07de1d62ec915f584e60653242acba1f9f33702a))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* Co-authored-by: release: Release 2 gems ([#1508](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1508) [f8d2551](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/f8d2551127271030f28e71170c51fdff3c0447d3))
  *  **opentelemetry-instrumentation-httpx 0.2.1** (was 0.2.0)
   *  **opentelemetry-resource-detector-aws 0.2.0** (was 0.1.0)
...
* release: release: Release 2 gems ([#1508](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1508) [f8d2551](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/f8d2551127271030f28e71170c51fdff3c0447d3))
  *  **opentelemetry-instrumentation-httpx 0.2.1** (was 0.2.0)
   *  **opentelemetry-resource-detector-aws 0.2.0** (was 0.1.0)

* fix: httpx instrumentation trace context propagation ([#1456](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1456) [fed9a0f](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/fed9a0f71d45ee726baa7c6d20f7ebe55bc71935))
  This PR should supersede https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1404 . It fixes distributed tracing propagation (the aim of the original MR). It also drops support for httpx < 1.x; it may still work with it, but the `webmock` integration with it is no longer made possible.

* fix: httpx instrumentation trace context propagation ([#1456](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1456) [fed9a0f](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/fed9a0f71d45ee726baa7c6d20f7ebe55bc71935))
  This PR should supersede https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1404 . It fixes distributed tracing propagation (the aim of the original MR). It also drops support for httpx < 1.x; it may still work with it, but the `webmock` integration with it is no longer made possible.

* **FIX:** fix: httpx instrumentation trace context propagation ([#1456](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1456) [fed9a0f](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/fed9a0f71d45ee726baa7c6d20f7ebe55bc71935))
  This PR should supersede https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1404 . It fixes distributed tracing propagation (the aim of the original MR). It also drops support for httpx < 1.x; it may still work with it, but the `webmock` integration with it is no longer made possible.

...
* [#1499](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1499) - chore: Address Style/RedundantParentheses
...
* chore: Address Style/RedundantParentheses ([#1499](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1499) [c64487d](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/c64487d3bb58f1f5bbe2a71980ef18ccf3a9611e))
  Rubocop 1.75.3 came out on 22 April. Our Gemfile is set to install new patch versions automatically. This cop started failing after the update with the message: Don't use parentheses around a method argument.

...
* [#1369](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1369) - docs: required version in Rails README from 0.24 to 0.34
  I think this is a small typo, it should be 0.34 and not 0.24, correct? [As 0.35 dropped support for 6.1](https://github.com/open-telemetry/opentelemetry-ruby-contrib/releases/tag/opentelemetry-instrumentation-rails%2Fv0.35.0)

* [#1372](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1372) - release: Release opentelemetry-instrumentation-rails 0.35.1 (was 0.35.0)
  *  **opentelemetry-instrumentation-rails 0.35.1** (was 0.35.0)
...
* [#1391](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1391) - feat: add active_storage instrumentation to `rails`
  related: #1307, #1313 
  
  This PR adds active_storage instrumentation implemented in #1313 to `rails`.
  After this is released, I'll create another PR to add require to `all` ([here](https://github.com/open-telemetry/opentelemetry-ruby-contrib/blob/main/instrumentation/all/lib/opentelemetry/instrumentation/all.rb)).
  ...
  ![image](https://github.com/user-attachments/assets/a92a2ca6-7fcd-4754-86fa-86cde0e9d4bb)
...
* **NEW:** feat: add active_storage instrumentation to `rails` ([#1391](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1391) [7949291](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/79492915fad7222ee9b81f66c18a8e177927bb94))
  related: #1307, #1313 
...
* Co-authored-by: release: Release opentelemetry-instrumentation-rails 0.35.1 (was 0.35.0) ([#1372](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1372) [14a6d96](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/14a6d963d14c71d54b9aafbabf60fa28f44f742c))
  *  **opentelemetry-instrumentation-rails 0.35.1** (was 0.35.0)

* Co-authored-by: release: Release opentelemetry-instrumentation-rails 0.35.1 (was 0.35.0) ([#1372](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1372) [14a6d96](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/14a6d963d14c71d54b9aafbabf60fa28f44f742c))
  *  **opentelemetry-instrumentation-rails 0.35.1** (was 0.35.0)

* release: release: Release opentelemetry-instrumentation-rails 0.35.1 (was 0.35.0) ([#1372](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1372) [14a6d96](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/14a6d963d14c71d54b9aafbabf60fa28f44f742c))
  *  **opentelemetry-instrumentation-rails 0.35.1** (was 0.35.0)

* **DOCS:** docs: required version in Rails README from 0.24 to 0.34 ([#1369](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1369) [a08467a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a08467abe1ba51c32bdcb1162008b7cf1eaf598b))
  I think this is a small typo, it should be 0.34 and not 0.24, correct? [As 0.35 dropped support for 6.1](https://github.com/open-telemetry/opentelemetry-ruby-contrib/releases/tag/opentelemetry-instrumentation-rails%2Fv0.35.0)

* **FIX:** docs: required version in Rails README from 0.24 to 0.34 ([#1369](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1369) [a08467a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a08467abe1ba51c32bdcb1162008b7cf1eaf598b))
  I think this is a small typo, it should be 0.34 and not 0.24, correct? [As 0.35 dropped support for 6.1](https://github.com/open-telemetry/opentelemetry-ruby-contrib/releases/tag/opentelemetry-instrumentation-rails%2Fv0.35.0)

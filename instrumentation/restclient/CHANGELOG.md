...
* [#1568](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1568) - feat: rest-client HTTP semantic convention stability migration
...
* feat: rest-client HTTP semantic convention stability migration ([#1568](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1568) [98446e7](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/98446e7d3ee28819adf687513a4772d9ac36a843))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* **NEW:** feat: rest-client HTTP semantic convention stability migration ([#1568](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1568) [98446e7](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/98446e7d3ee28819adf687513a4772d9ac36a843))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only

...
* [#1480](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1480) - feat: support meta protocol instrumentation
...
* [#1489](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1489) - chore: only prepend Dalli patch if binary protocol defined
...
* [#1494](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1494) - release: Release opentelemetry-instrumentation-dalli 0.27.1 (was 0.27.0)
  *  **opentelemetry-instrumentation-dalli 0.27.1** (was 0.27.0)

* [#1511](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1511) - fix: Do not pollute the `OpenTelemetry::Instrumentation` namespace
...
* [#1513](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1513) - release: Release opentelemetry-instrumentation-dalli 0.27.2 (was 0.27.1)
  *  **opentelemetry-instrumentation-dalli 0.27.2** (was 0.27.1)

* [#1548](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1548) - fix: compact Dalli attributes
...
* [#1549](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1549) - release: Release opentelemetry-instrumentation-dalli 0.27.3 (was 0.27.2)
  *  **opentelemetry-instrumentation-dalli 0.27.3** (was 0.27.2)
...
* Co-authored-by: release: Release opentelemetry-instrumentation-dalli 0.27.3 (was 0.27.2) ([#1549](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1549) [434473c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/434473c150534d234114e00e419887cee7c4efcb))
  *  **opentelemetry-instrumentation-dalli 0.27.3** (was 0.27.2)

* Co-authored-by: release: Release opentelemetry-instrumentation-dalli 0.27.3 (was 0.27.2) ([#1549](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1549) [434473c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/434473c150534d234114e00e419887cee7c4efcb))
  *  **opentelemetry-instrumentation-dalli 0.27.3** (was 0.27.2)

* release: release: Release opentelemetry-instrumentation-dalli 0.27.3 (was 0.27.2) ([#1549](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1549) [434473c](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/434473c150534d234114e00e419887cee7c4efcb))
  *  **opentelemetry-instrumentation-dalli 0.27.3** (was 0.27.2)

* **FIX:** fix: compact Dalli attributes ([#1548](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1548) [4dbb668](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/4dbb668aa3cb86a06e948c0e0b0f47dba7cd7f8b))
  Dalli supports connecting to Memcached over a [UNIX domain socket](https://github.com/petergoldstein/dalli/wiki/Server-Configuration#individual-server-configuration-strings) in which case the [`port` is nil](https://github.com/Shopify/dalli/blob/main/lib/dalli/protocol/server_config_parser.rb#L60-L65). This will raise `OpenTelemetry error: invalid span attribute value type NilClass for key 'net.peer.port' on span 'set' (OpenTelemetry::Error)` ([source](https://github.com/Shopify/opentelemetry-ruby-shopify/blob/main/opentelemetry-shopify/lib/opentelemetry/shopify.rb#L291-L301)).
  
  This PR attempts to address this by compacting the `attributes`. I'm curious if folks think the test is digging too deep into Dalli internals. I just mainly wanted to avoid spinning up a separate Memcached server that is listening over a UNIX domain socket to test this. I'm all ears for other approaches too.

* Co-authored-by: release: Release opentelemetry-instrumentation-dalli 0.27.2 (was 0.27.1) ([#1513](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1513) [9dcff88](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/9dcff8859b58d2a6e9ab25a9a4d1c407c4700f66))
  *  **opentelemetry-instrumentation-dalli 0.27.2** (was 0.27.1)

* Co-authored-by: release: Release opentelemetry-instrumentation-dalli 0.27.2 (was 0.27.1) ([#1513](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1513) [9dcff88](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/9dcff8859b58d2a6e9ab25a9a4d1c407c4700f66))
  *  **opentelemetry-instrumentation-dalli 0.27.2** (was 0.27.1)

* release: release: Release opentelemetry-instrumentation-dalli 0.27.2 (was 0.27.1) ([#1513](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1513) [9dcff88](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/9dcff8859b58d2a6e9ab25a9a4d1c407c4700f66))
  *  **opentelemetry-instrumentation-dalli 0.27.2** (was 0.27.1)

* **FIX:** fix: Do not pollute the `OpenTelemetry::Instrumentation` namespace ([#1511](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1511) [de4da24](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/de4da2473a851979823c0dcfcc87642494187afc))
  The `dalli` instrumentation is defining a `Utils` module under the `OpenTelemetry::Instrumentation`. The `Utils` module should be an internal concern of the instrumentation library, and thus, the module should've been under the `OpenTelemetry::Instrumentation::Dalli` namespace.
  
  Also, the file was already under the `lib/opentelemetry/instrumentation/dalli` folder, so the `OpenTelemetry::Instrumentation::Dalli` namespace is more appropriate.

* Co-authored-by: release: Release opentelemetry-instrumentation-dalli 0.27.1 (was 0.27.0) ([#1494](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1494) [a171fb1](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a171fb11672a8c66a6d1f1492c30399270c545e3))
  *  **opentelemetry-instrumentation-dalli 0.27.1** (was 0.27.0)

* Co-authored-by: release: Release opentelemetry-instrumentation-dalli 0.27.1 (was 0.27.0) ([#1494](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1494) [a171fb1](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a171fb11672a8c66a6d1f1492c30399270c545e3))
  *  **opentelemetry-instrumentation-dalli 0.27.1** (was 0.27.0)

* release: release: Release opentelemetry-instrumentation-dalli 0.27.1 (was 0.27.0) ([#1494](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1494) [a171fb1](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a171fb11672a8c66a6d1f1492c30399270c545e3))
  *  **opentelemetry-instrumentation-dalli 0.27.1** (was 0.27.0)

* **FIX:** chore: only prepend Dalli patch if binary protocol defined ([#1489](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1489) [74875b7](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/74875b7bc68d2ff6c8018fa3733437ea4bdef196))
  Follow up to https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1480.
  
  We removed the binary protocol from Shopify's fork of Dalli (https://github.com/Shopify/dalli/pull/13) since it is officially deprecated by Memcached (https://docs.memcached.org/protocols/#why-is-the-binary-protocol-deprecated). I know it's also on upstream Dalli's roadmap to remove it as well. So this PR just ensures that `::Dalli::Protocol::Binary` is defined before applying the patch.

* chore: only prepend Dalli patch if binary protocol defined ([#1489](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1489) [74875b7](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/74875b7bc68d2ff6c8018fa3733437ea4bdef196))
  Follow up to https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1480.
  
  We removed the binary protocol from Shopify's fork of Dalli (https://github.com/Shopify/dalli/pull/13) since it is officially deprecated by Memcached (https://docs.memcached.org/protocols/#why-is-the-binary-protocol-deprecated). I know it's also on upstream Dalli's roadmap to remove it as well. So this PR just ensures that `::Dalli::Protocol::Binary` is defined before applying the patch.

* feat: support meta protocol instrumentation ([#1480](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1480) [db1286a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/db1286a82a85dd99c1e9760a4a0811fbfa6ec4c2))
  Dalli supports [Memcached's meta protocol](https://docs.memcached.org/protocols/meta/) as of [3.2.0](https://github.com/petergoldstein/dalli/blob/main/CHANGELOG.md#320). This PR adds support for instrumentation when clients are using the meta protocol.

* **NEW:** feat: support meta protocol instrumentation ([#1480](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1480) [db1286a](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/db1286a82a85dd99c1e9760a4a0811fbfa6ec4c2))
  Dalli supports [Memcached's meta protocol](https://docs.memcached.org/protocols/meta/) as of [3.2.0](https://github.com/petergoldstein/dalli/blob/main/CHANGELOG.md#320). This PR adds support for instrumentation when clients are using the meta protocol.

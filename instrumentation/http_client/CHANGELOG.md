...
* [#1389](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1389) - refactor: Use Block Argument Forwarding
...
* [#1588](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1588) - feat: Begin HTTPClient semantic convention stability migration
...
* [#1636](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1636) - test: add appraisal for an unlocked/nil version
  1. This will test instrumentation against the latest available HTTPClient gem
  2. Closes #1600

### Instrumentation: HTTP_CLIENT

* **TEST:** test: add appraisal for an unlocked/nil version ([#1636](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1636) [a9ff3d9](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/a9ff3d90b36ea7e6dd1098900e423d179539c23d))
  1. This will test instrumentation against the latest available HTTPClient gem
  2. Closes #1600

* feat: Begin HTTPClient semantic convention stability migration ([#1588](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1588) [c3edc8d](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/c3edc8d1394d9e14f567267e712138aa6f9ef39c))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* **NEW:** feat: Begin HTTPClient semantic convention stability migration ([#1588](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1588) [c3edc8d](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/c3edc8d1394d9e14f567267e712138aa6f9ef39c))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* refactor: Use Block Argument Forwarding ([#1389](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1389) [e246354](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/e2463549c278ba871ae6bc315be2c388ae6ce4fc))
  > This cop identifies places where do_something(&block) can be replaced by do_something(&)
  
  https://docs.rubocop.org/rubocop/cops_style.html#styleargumentsforwarding
  https://docs.rubocop.org/rubocop/cops_naming.html#namingblockforwarding

* **REFACTOR:** refactor: Use Block Argument Forwarding ([#1389](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1389) [e246354](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/e2463549c278ba871ae6bc315be2c388ae6ce4fc))
  > This cop identifies places where do_something(&block) can be replaced by do_something(&)

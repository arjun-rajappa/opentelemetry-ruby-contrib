...
* [#1561](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1561) - feat: Ethon HTTP semantic convention stability migration
...
* feat: Ethon HTTP semantic convention stability migration ([#1561](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1561) [774496f](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/774496f6c7b1e8eff8c44c74f924dbf3cad1e855))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only
...
* **NEW:** feat: Ethon HTTP semantic convention stability migration ([#1561](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1561) [774496f](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/774496f6c7b1e8eff8c44c74f924dbf3cad1e855))
  This PR is intended to assist in the transition from the old to new HTTP semantic conventions. Per the [HTTP semantic convention stability migration spec](https://opentelemetry.io/docs/specs/semconv/non-normative/http-migration/), users should be able to set the environment variable `OTEL_SEMCONV_STABILITY_OPT_IN` to:
  - `http` to emit stable conventions only
  - `http/dup` to emit both old and the stable conventions
  -  a blank env var will emit old conventions only

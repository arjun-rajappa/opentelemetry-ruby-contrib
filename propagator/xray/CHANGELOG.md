...
* [#1464](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1464) - feat: contribute xray lambda propagator
  ## What does this pull request do?
  Adding functionality to extract trace context in Lambda environments according to [OTel propagator spec](https://opentelemetry.io/docs/specs/semconv/faas/aws-lambda/#xray-lambda-propagator-functionality).
  ...
  ## Test plan
  Set up a lambda function with [lambda library instrumentation](https://github.com/yiyuan-he/opentelemetry-ruby-contrib/tree/main/instrumentation/aws_lambda) and new xray lambda propagator to verify the context propagation works.
  
  <img width="908" alt="Screenshot 2025-04-02 at 3 42 20 PM" src="https://github.com/user-attachments/assets/8cfcbeb9-ad53-4860-ac9f-902878ad06a6" />
  
  
  ## Related Issues
  https://github.com/open-telemetry/opentelemetry-ruby-contrib/issues/1462
...
* feat: contribute xray lambda propagator ([#1464](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1464) [07d188e](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/07d188e503a760d05e6c8953e083662f64d4a88d))
  ## What does this pull request do?
  Adding functionality to extract trace context in Lambda environments according to [OTel propagator spec](https://opentelemetry.io/docs/specs/semconv/faas/aws-lambda/#xray-lambda-propagator-functionality).
...
* **NEW:** feat: contribute xray lambda propagator ([#1464](https://github.com/open-telemetry/opentelemetry-ruby-contrib/pull/1464) [07d188e](https://github.com/open-telemetry/opentelemetry-ruby-contrib/commit/07d188e503a760d05e6c8953e083662f64d4a88d))
  ## What does this pull request do?
  Adding functionality to extract trace context in Lambda environments according to [OTel propagator spec](https://opentelemetry.io/docs/specs/semconv/faas/aws-lambda/#xray-lambda-propagator-functionality).
